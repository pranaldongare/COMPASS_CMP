...
const EVENT_SENTENCES: Record<string, string> = {
  "rights.ticket_issued":
    "A ticket was issued: an instruction, a date, and what the platform already holds.",
  ...
  "rights.ticket_sent_back":
    "The Privacy Office was not satisfied with a return and sent the ticket back with a reason.",
  "rights.ticket_withdrawn":
    "A ticket was withdrawn; nothing further is needed from the holder.",
