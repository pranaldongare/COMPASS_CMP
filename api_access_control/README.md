...
Reviewed on **2026-09-17** against commit **`1757d5069ba723f260c88c45419c1286261a127f`**, branch **`refactor/frontend-architecture`**; amended the same day at **`c7d3f6ba15a5cfdc6f9df6632c9c7e336c9936fa`** for the audit trail's four new endpoints (summary, vocabulary, lookup, export).
...
**Coverage: 17 modules, 245 documented operations over 215 OpenAPI paths, plus 3 registered system operations excluded from OpenAPI (248 total operations).** No framework-generated Swagger/ReDoc/OpenAPI routes or middleware-generated OPTIONS responses are counted.
