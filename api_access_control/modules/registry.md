...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L352).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L366).
...
- **Resolved gate:** `RequireResource(processor, write=False)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L506).
...
- **Resolved gate:** `RequireResource(processor, write=True)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L518).
...
- **Resolved gate:** `RequireResource(processor, write=False)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L398).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L415).
...
- **Route guard:** `Annotated[Any, Depends(RequireRole(Role.DPO, Role.ADMIN))]`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L480).
...
- **Resolved gate:** `RequireResource(processor, write=True)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L544).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L134).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L151).
...
- **Resolved gate:** `RequireResource(purpose, write=False)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L174).
...
- **Resolved gate:** `Annotated[Principal, Depends(RequireRole(Role.DPO))]`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L183).
...
- **Resolved gate:** `Annotated[Principal, Depends(RequireRole(Role.DPO))]`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L207).
...
- **Resolved gate:** `Annotated[Principal, Depends(RequireRole(Role.DPO))]`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L225).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L274).
...
- **Resolved gate:** `Annotated[Principal, Depends(RequireRole(Role.DPO, Role.ADMIN))]`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L263).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L616).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L664).
...
- **Resolved gate:** `RequireResource(data_source, write=False)`.
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L746).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L758).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L904), [source 2](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/db/repositories/exchange.py#L380), [source 3](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/db/repositories/exchange.py#L405).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- Current handler resolves a source by UUID without caller ownership filtering. All data_source writers can act on any source. Owner assignment validates the target owner’s role, not the actor’s source ownership.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L816), [source 2](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L758).
...
- **Rules:** Registry access is separate from project ownership. Listing/reading a registry entry does not grant access to the projects using it.
- Current handler resolves a source by UUID without caller ownership filtering. All data_source writers can act on any source. Owner assignment validates the target owner’s role, not the actor’s source ownership.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L885), [source 2](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/cmp_backend/src/cmp/api/routers/v1/registry.py#L758).
