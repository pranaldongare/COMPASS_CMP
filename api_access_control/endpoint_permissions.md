...
| PUT | `/notices/{notice_uuid}` | NO | ALL | NO | NO | NO | NO | OWN | NO |
...
| POST | `/notices/{notice_uuid}/languages` | NO | ALL | NO | NO | NO | NO | OWN | NO |
| PUT | `/notices/{notice_uuid}/languages/{code}` | NO | ALL | NO | NO | NO | NO | OWN | NO |
...
| POST | `/notices/{notice_uuid}/purposes` | NO | ALL | NO | NO | NO | NO | OWN | NO |
| POST | `/notices/{notice_uuid}/purposes/activate` | NO | ALL | NO | NO | NO | NO | NO | NO |
| DELETE | `/notices/{notice_uuid}/purposes/{purpose_uuid}` | NO | ALL | NO | NO | NO | NO | OWN | NO |
| PUT | `/notices/{notice_uuid}/purposes/{purpose_uuid}` | NO | ALL | NO | NO | NO | NO | OWN | NO |
...
| POST | `/projects/{project_uuid}/notices` | NO | ALL | NO | NO | NO | NO | OWN | NO |
