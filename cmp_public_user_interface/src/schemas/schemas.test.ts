...
describe("credentials", () => {
  ...
  it("sign-in stays loose about the shape of a contact", () => {
    ...
    // this form.
    expect(otpRequestSchema.safeParse({ contact: "+91 98765 43210" }).success).toBe(true);
    expect(otpRequestSchema.safeParse({ contact: "asha@organisation.example" }).success).toBe(true);
