...
|---|---|---|
| [`cmp_backend/`](cmp_backend) | FastAPI 0.141, PostgreSQL 16, Redis 7, Celery 5, Python 3.12 | The API: 233 endpoints, 31 tables, raw SQL over psycopg 3, no ORM, 22 raw-SQL migrations |
