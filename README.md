...
|---|---|---|
| [`backend/api/`](backend/api) | FastAPI 0.141, PostgreSQL 16, Redis 7, Celery 5, Python 3.12 | The API: 252 endpoints, 35 tables, raw SQL over psycopg 3, no ORM, 30 migrations |
