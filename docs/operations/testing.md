...
2026-09-17 and change with every feature; the commands do not.
...
acceptance, the data principal's own pages, and a member of staff signing in as a data
principal. `expectNoSidewaysScroll` in
