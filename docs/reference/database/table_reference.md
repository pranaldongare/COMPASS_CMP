...
Generated by `docs/tools/generate-schema-docs.py` from PostgreSQL 16.15 after applying all 30 repository migrations to an empty isolated instance (head **0030**). View columns do not carry reliable NOT NULL metadata; their nullability is shown as derived. `UQ` marks membership in a unique constraint, including composite constraints; unique indexes and CHECK expressions are listed separately.
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK040 | updated_by | auth_user(id) | FOREIGN KEY (updated_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK041 | invoked_request_id | rights_request(request_id) | FOREIGN KEY (invoked_request_id) REFERENCES rights_request(request_id) |
| FK042 | nominee_user_id | auth_user(id) | FOREIGN KEY (nominee_user_id) REFERENCES auth_user(id) |
| FK043 | principal_user_id | auth_user(id) | FOREIGN KEY (principal_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK044 | approved_by | auth_user(id) | FOREIGN KEY (approved_by) REFERENCES auth_user(id) |
| FK048 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK049 | notice_id | notice(notice_id) | FOREIGN KEY (notice_id) REFERENCES notice(notice_id) |
| FK050 | overridden_by | auth_user(id) | FOREIGN KEY (overridden_by) REFERENCES auth_user(id) |
| FK051 | purpose_id | purpose(purpose_id) | FOREIGN KEY (purpose_id) REFERENCES purpose(purpose_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK052 | auth_user_id | auth_user(id) | FOREIGN KEY (auth_user_id) REFERENCES auth_user(id) |
| FK053 | changed_by | auth_user(id) | FOREIGN KEY (changed_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK054 | processor_id | processor(processor_id) | FOREIGN KEY (processor_id) REFERENCES processor(processor_id) |
| FK055 | user_id | auth_user(id) | FOREIGN KEY (user_id) REFERENCES auth_user(id) |
...
| FK058 | created_by | auth_user(id) | FOREIGN KEY (created_by) REFERENCES auth_user(id) |
| FK059 | dco_user_id | auth_user(id) | FOREIGN KEY (dco_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK056 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
| FK057 | uploaded_by | auth_user(id) | FOREIGN KEY (uploaded_by) REFERENCES auth_user(id) |
...
| FK084 | linked_request_id | rights_request(request_id) | FOREIGN KEY (linked_request_id) REFERENCES rights_request(request_id) |
| FK085 | nomination_id | nomination(nomination_id) | FOREIGN KEY (nomination_id) REFERENCES nomination(nomination_id) |
| FK086 | responded_by | auth_user(id) | FOREIGN KEY (responded_by) REFERENCES auth_user(id) |
| FK087 | reviewer_user_id | auth_user(id) | FOREIGN KEY (reviewer_user_id) REFERENCES auth_user(id) |
| FK088 | subject_user_id | auth_user(id) | FOREIGN KEY (subject_user_id) REFERENCES auth_user(id) |
| FK089 | verified_by | auth_user(id) | FOREIGN KEY (verified_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK075 | confirmed_by | auth_user(id) | FOREIGN KEY (confirmed_by) REFERENCES auth_user(id) |
| FK076 | processor_id | processor(processor_id) | FOREIGN KEY (processor_id) REFERENCES processor(processor_id) |
| FK077 | request_id | rights_request(request_id) | FOREIGN KEY (request_id) REFERENCES rights_request(request_id) |
| FK078 | respondent_id | processor_respondent(respondent_id) | FOREIGN KEY (respondent_id) REFERENCES processor_respondent(respondent_id) |
| FK079 | responder_user_id | auth_user(id) | FOREIGN KEY (responder_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK080 | asset_consent_id | asset_consent(asset_consent_id) | FOREIGN KEY (asset_consent_id) REFERENCES asset_consent(asset_consent_id) |
| FK081 | decided_by | auth_user(id) | FOREIGN KEY (decided_by) REFERENCES auth_user(id) |
| FK082 | holder_id | rights_request_holder(holder_id) | FOREIGN KEY (holder_id) REFERENCES rights_request_holder(holder_id) |
