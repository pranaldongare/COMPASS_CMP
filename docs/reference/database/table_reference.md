...
Generated by `docs/tools/generate-schema-docs.py` from PostgreSQL 16.15 after applying all 31 repository migrations to an empty isolated instance (head **0031**). View columns do not carry reliable NOT NULL metadata; their nullability is shown as derived. `UQ` marks membership in a unique constraint, including composite constraints; unique indexes and CHECK expressions are listed separately.
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK036 | registered_via_link_id | consent_link(link_id) | FOREIGN KEY (registered_via_link_id) REFERENCES consent_link(link_id) |
...
| FK030 | export_id | export_log(export_id) | FOREIGN KEY (export_id) REFERENCES export_log(export_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK031 | exported_by | auth_user(id) | FOREIGN KEY (exported_by) REFERENCES auth_user(id) |
| FK032 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
| FK033 | site_id | project_site(site_id) | FOREIGN KEY (site_id) REFERENCES project_site(site_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK037 | imported_by | auth_user(id) | FOREIGN KEY (imported_by) REFERENCES auth_user(id) |
| FK038 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
| FK039 | source_id | data_source(source_id) | FOREIGN KEY (source_id) REFERENCES data_source(source_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK040 | asset_id | data_asset(asset_id) | FOREIGN KEY (asset_id) REFERENCES data_asset(asset_id) |
| FK041 | placed_by | auth_user(id) | FOREIGN KEY (placed_by) REFERENCES auth_user(id) |
| FK042 | released_by | auth_user(id) | FOREIGN KEY (released_by) REFERENCES auth_user(id) |
| FK043 | subject_user_id | auth_user(id) | FOREIGN KEY (subject_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK044 | updated_by | auth_user(id) | FOREIGN KEY (updated_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK045 | invoked_request_id | rights_request(request_id) | FOREIGN KEY (invoked_request_id) REFERENCES rights_request(request_id) |
| FK046 | nominee_user_id | auth_user(id) | FOREIGN KEY (nominee_user_id) REFERENCES auth_user(id) |
| FK047 | principal_user_id | auth_user(id) | FOREIGN KEY (principal_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK048 | approved_by | auth_user(id) | FOREIGN KEY (approved_by) REFERENCES auth_user(id) |
| FK052 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
...
| FK050 | created_by | auth_user(id) | FOREIGN KEY (created_by) REFERENCES auth_user(id) |
| FK051 | notice_id | notice(notice_id) | FOREIGN KEY (notice_id) REFERENCES notice(notice_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK053 | notice_id | notice(notice_id) | FOREIGN KEY (notice_id) REFERENCES notice(notice_id) |
| FK054 | overridden_by | auth_user(id) | FOREIGN KEY (overridden_by) REFERENCES auth_user(id) |
| FK055 | purpose_id | purpose(purpose_id) | FOREIGN KEY (purpose_id) REFERENCES purpose(purpose_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK056 | auth_user_id | auth_user(id) | FOREIGN KEY (auth_user_id) REFERENCES auth_user(id) |
| FK057 | changed_by | auth_user(id) | FOREIGN KEY (changed_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK058 | processor_id | processor(processor_id) | FOREIGN KEY (processor_id) REFERENCES processor(processor_id) |
| FK059 | user_id | auth_user(id) | FOREIGN KEY (user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK034 | current_notice_id | notice(notice_id) | FOREIGN KEY (current_notice_id) REFERENCES notice(notice_id) |
| FK062 | created_by | auth_user(id) | FOREIGN KEY (created_by) REFERENCES auth_user(id) |
| FK063 | dco_user_id | auth_user(id) | FOREIGN KEY (dco_user_id) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK060 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
| FK061 | uploaded_by | auth_user(id) | FOREIGN KEY (uploaded_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK064 | added_by | auth_user(id) | FOREIGN KEY (added_by) REFERENCES auth_user(id) |
| FK065 | decided_by | auth_user(id) | FOREIGN KEY (decided_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK068 | dco_override_by | auth_user(id) | FOREIGN KEY (dco_override_by) REFERENCES auth_user(id) |
| FK069 | dco_override_user_id | auth_user(id) | FOREIGN KEY (dco_override_user_id) REFERENCES auth_user(id) |
| FK070 | processor_id | processor(processor_id) | FOREIGN KEY (processor_id) REFERENCES processor(processor_id) |
| FK071 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
| FK072 | source_id | data_source(source_id) | FOREIGN KEY (source_id) REFERENCES data_source(source_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK073 | actor_user_id | auth_user(id) | FOREIGN KEY (actor_user_id) REFERENCES auth_user(id) |
| FK074 | project_id | project(project_id) | FOREIGN KEY (project_id) REFERENCES project(project_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK075 | created_by | auth_user(id) | FOREIGN KEY (created_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK076 | attempted_by | auth_user(id) | FOREIGN KEY (attempted_by) REFERENCES auth_user(id) |
| FK077 | item_id | rights_request_item(item_id) | FOREIGN KEY (item_id) REFERENCES rights_request_item(item_id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK078 | classified_by | auth_user(id) | FOREIGN KEY (classified_by) REFERENCES auth_user(id) |
| FK079 | consent_id | consent_artefact(consent_id) | FOREIGN KEY (consent_id) REFERENCES consent_artefact(consent_id) |
| FK080 | created_by | auth_user(id) | FOREIGN KEY (created_by) REFERENCES auth_user(id) |
| FK090 | linked_request_id | rights_request(request_id) | FOREIGN KEY (linked_request_id) REFERENCES rights_request(request_id) |
| FK091 | nomination_id | nomination(nomination_id) | FOREIGN KEY (nomination_id) REFERENCES nomination(nomination_id) |
| FK092 | responded_by | auth_user(id) | FOREIGN KEY (responded_by) REFERENCES auth_user(id) |
| FK093 | reviewer_user_id | auth_user(id) | FOREIGN KEY (reviewer_user_id) REFERENCES auth_user(id) |
| FK094 | subject_user_id | auth_user(id) | FOREIGN KEY (subject_user_id) REFERENCES auth_user(id) |
| FK095 | verified_by | auth_user(id) | FOREIGN KEY (verified_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK096 | request_id | rights_request(request_id) | FOREIGN KEY (request_id) REFERENCES rights_request(request_id) |
| FK097 | uploaded_by | auth_user(id) | FOREIGN KEY (uploaded_by) REFERENCES auth_user(id) |
...
| ID | Column(s) | Referenced key | Definition |
| --- | --- | --- | --- |
| FK098 | author_user_id | auth_user(id) | FOREIGN KEY (author_user_id) REFERENCES auth_user(id) |
| FK099 | holder_id | rights_request_holder(holder_id) | FOREIGN KEY (holder_id) REFERENCES rights_request_holder(holder_id) |
