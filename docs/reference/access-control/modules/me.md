...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L114).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L123).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L253).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L267).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L311).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L320).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L288).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L332).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L366).
...
- Shared account/profile route: staff sessions are accepted. POST /me/person-type is narrower: DPO, Admin and data_subject only.
- Adding/changing a contact does not make it usable for sign-in until the matching code is verified.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L191).
...
- Shared account/profile route: staff sessions are accepted. POST /me/person-type is narrower: DPO, Admin and data_subject only.
- Adding/changing a contact does not make it usable for sign-in until the matching code is verified.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L181).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L387).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1615).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1657).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1672).
...
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1625).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L394).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Shared account/profile route: staff sessions are accepted. POST /me/person-type is narrower: DPO, Admin and data_subject only.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/me.py#L212).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1483).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1495).
...
- **Rules:** Only the signed-in person’s record or their related records; an account UUID supplied by the client does not select a different principal.
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1597).
...
- Also reachable by the **nominee** who raised this request, matched through `nomination.nominee_user_id` (`request_as_nominee`). Under s.14 they are the person exercising the right, and every message about the request already goes to them. Reading only: `POST /me/requests/{request_uuid}/dispute` makes a new request in the principal's name and stays on the acting side, which needs the nominee page and a code ([ADR 0014](../../../decisions/0014-a-nominee-follows-the-request-they-raised.md)).
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1567).
...
- Also reachable by the **nominee** who raised this request, matched through `nomination.nominee_user_id` (`request_as_nominee`). Under s.14 they are the person exercising the right, and every message about the request already goes to them. Reading only: `POST /me/requests/{request_uuid}/dispute` makes a new request in the principal's name and stays on the acting side, which needs the nominee page and a code ([ADR 0014](../../../decisions/0014-a-nominee-follows-the-request-they-raised.md)).
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1580).
...
- Also reachable by the **nominee** who raised this request, matched through `nomination.nominee_user_id` (`request_as_nominee`). Under s.14 they are the person exercising the right, and every message about the request already goes to them. Reading only: `POST /me/requests/{request_uuid}/dispute` makes a new request in the principal's name and stays on the acting side, which needs the nominee page and a code ([ADR 0014](../../../decisions/0014-a-nominee-follows-the-request-they-raised.md)).
- Effective session role must be data_subject. Staff account holders can use this endpoint through a portal OTP session acting as data_subject.
- **Evidence:** [source 1](https://github.com/pranaldongare/COMPASS_CMP/blob/1757d5069ba723f260c88c45419c1286261a127f/backend/api/src/cmp/api/routers/v1/rights.py#L1556).
